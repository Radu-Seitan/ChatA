...
namespace ChatA.Infrastructure.Migrations
{
    ...
    [Migration("20210827102721_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatA.Domain.Entities.GroupMembership", b =>
                {
                    ...
                    b.Property<int?>("GroupMessageRoomId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatA.Domain.Entities.GroupMembership", b =>
                {
                    b.HasOne("ChatA.Domain.Entities.GroupMessageRoom", "GroupMessageRoom")
                        .WithMany("Memberships")
                        .HasForeignKey("GroupMessageRoomId");
